...
-- Rational extension and its genuine conjugate operation.
...
-- Sum/product dichotomy and conditional refined gap.
...
-- Actual ZMod multiplicative orders.
...
-- Full algebraic coordinate and cancellation.
...
-- Exact finite foundations, not an infinite correlation assertion.
...
#print axioms OmegaBalance.f3APPrimes_pow_three_sub_one_succ_subset
#print axioms OmegaBalance.f3APPrimes_pow_three_one_succ_subset
#print axioms OmegaBalance.f3PrimePosLevelPrimes_eq_sdiff
#print axioms OmegaBalance.f3PrimeNegLevelPrimes_eq_sdiff
#print axioms OmegaBalance.f3PrimePosLevelCountingReal_eq_residue
#print axioms OmegaBalance.f3PrimeNegLevelCountingReal_eq_residue
#print axioms OmegaBalance.f3PrimePosLevelCountingReal_normalized_tendsto
#print axioms OmegaBalance.f3PrimeNegLevelCountingReal_normalized_tendsto_above_three
